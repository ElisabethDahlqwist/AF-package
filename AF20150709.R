...
#' @description Estimate the model-based adjusted attributable fraction for data from a cross-sectional sampling design.
...
#' @return The estimated attributable fraction and standard errors for the estimate
#' @export
...
#' @param object object of class AF
#' @param confidence.level specify confidence level for the Wald confidence intervals. Default is 95 percent.
#' @param CI.transform a string specifying a transformation of the Wald confidence interval. Log-transform ("log") or Logit-transform ("logit") are optional. Default is untransformed confidence interval.
#' @details Present a summary and calculate Wald confidence intervals with log, logit and untransformed confidence intervals.
#' @export
